...
// Forwarder presets: realistic cost structures for popular China→EU buying agents.
// These are used by the UI to let the user switch between forwarders with one click.
...
export const FORWARDER_PRESETS: ForwarderPreset[] = [
  {
    id: "cssbuy",
    label: "CSS Buy",
    description: "5% agent fee, €3 inspection, €5 CN shipping, 1.5% insurance, €30 intl shipping, €15 customs",
    agent_service_fee_rate: 0.05,
    inspection_fee_eur: 3,
    domestic_shipping_cn_eur: 5,
    insurance_fee_rate: 0.015,
    international_shipping_eur: 30,
    customs_clearance_fee_eur: 15,
  },
  {
    id: "superbuy",
    label: "Superbuy",
    description: "5% agent fee, €4 inspection, €4 CN shipping, 1% insurance, €28 intl shipping, €15 customs. Slightly cheaper shipping.",
    agent_service_fee_rate: 0.05,
    inspection_fee_eur: 4,
    domestic_shipping_cn_eur: 4,
    insurance_fee_rate: 0.01,
    international_shipping_eur: 28,
    customs_clearance_fee_eur: 15,
  },
  {
    id: "wegobuy",
    label: "Wegobuy",
    description: "4% agent fee, €4 inspection, €5 CN shipping, 1.5% insurance, €32 intl shipping, €15 customs. Lower agent fee.",
    agent_service_fee_rate: 0.04,
    inspection_fee_eur: 4,
    domestic_shipping_cn_eur: 5,
    insurance_fee_rate: 0.015,
    international_shipping_eur: 32,
    customs_clearance_fee_eur: 15,
  },
  {
    id: "bhiner",
    label: "Bhiner / 86Daigou",
    description: "3% agent fee, €5 inspection, €6 CN shipping, 1% insurance, €35 intl shipping, €18 customs. Cheapest agent fee but higher shipping.",
    agent_service_fee_rate: 0.03,
    inspection_fee_eur: 5,
    domestic_shipping_cn_eur: 6,
    insurance_fee_rate: 0.01,
    international_shipping_eur: 35,
    customs_clearance_fee_eur: 18,
  },
  {
    id: "custom",
    label: "Custom",
    description: "Manually configure all fees. For users who have their own shipping arrangement or forwarder.",
    agent_service_fee_rate: 0.05,
    inspection_fee_eur: 3,
    domestic_shipping_cn_eur: 5,
    insurance_fee_rate: 0.015,
